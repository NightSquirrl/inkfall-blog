...
正常 Diff 两个树的时间复杂度是 O(n<sup>3)，但实际情况下我们很少会进行跨层级的移动 DOM，所以 Vue 将 Diff 进行了优化，从O(n</sup>3) -> O(n)，只有当新旧 children 都为多个子节点时才需要用核心的 Diff 算法进行同层级比较。
...
![image-20240216013934932](/Users/zeroeldath/Library/Application%20Support/typora-user-images/image-20240216013934932.png)
