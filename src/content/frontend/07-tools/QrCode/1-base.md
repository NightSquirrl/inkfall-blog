  ...
  for (let x = 0; x < nCount; x++) {
    for (let y = 0; y < nCount; y++) {
      ...
      if (typeTable[x][y] == QRPointType.POS_CENTER) {
        ...
        pointList.push(
          <circle key={id++} fill="none" strokeWidth="1" stroke="#000000" cx={x + 0.5} cy={y + 0.5} r={3} />,
        );
        // 等于3  4  5
      } else if (
...
1. 全局状态定义
   ...
   // 锚点颜色数值
   const [sketchColorAnchor, setSketchColorAnchor] = useLocalStorage("sketch_color_Anchor", {
     r: "241",
     g: "112",
     b: "19",
     a: "1",
